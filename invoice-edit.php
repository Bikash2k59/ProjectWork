			...
			<div id="invoice_totals" class="padding-right row text-right">
				...
				<div class="col-xs-6 no-padding-right">
					<div class="row">
						...
						<div class="col-xs-3">
							<?php echo "Rs." ?><span class="invoice-sub-total"> <?php echo $invoice_subtotal; ?></span>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<?php echo "Rs." ?><span class="invoice-discount"> <?php echo $invoice_discount; ?></span>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<?php echo "Rs."?><span class="invoice-vat" data-enable-vat="<?php echo ENABLE_VAT ?>" data-vat-rate="<?php echo VAT_RATE ?>" data-vat-method="<?php echo VAT_INCLUDED ?>"><?php echo $invoice_vat; ?></span>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<?php echo "Rs."?><span class="invoice-total"> <?php echo $invoice_total; ?></span>
