			...
			<table class="table table-bordered table-hover table-striped" id="invoice_table">
				...
				<tbody>
					<tr>
						...
						<td class="text-right">
							<div class="form-group form-group-sm  no-margin-bottom">
								<input type="text" class="form-control calculate" name="invoice_product_discount[]" placeholder="Enter % OR value (ex: 13% or 10.50)">
							</div>
						</td>
						<td class="text-right">
			...
			<div id="invoice_totals" class="padding-right row text-right">
				...
				<div class="col-xs-6 no-padding-right">
					<div class="row">
						...
						<div class="col-xs-3">
							<?php echo "Rs."?><span class="invoice-sub-total">0.00</span>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<?php echo "Rs." ?><span class="invoice-discount">0.00</span>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							<?php echo "Rs." ?><span class="invoice-vat" data-enable-vat="<?php echo ENABLE_VAT ?>" data-vat-rate="<?php echo VAT_RATE ?>" data-vat-method="<?php echo VAT_INCLUDED ?>">0.00</span>
